...
// Пишет поле [uint16 len][data] в buf со смещения off и возвращает новое
// смещение. При нехватке места или len > 65535 возвращает 0 и ничего не пишет:
// ноль легитимным результатом быть не может, даже пустое поле занимает два
// байта. До 1.4.10 предела не было, и функция молча писала за границу буфера.
